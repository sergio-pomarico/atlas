...
async function main(): Promise<void> {
  ...
  // 1. Validate args before loading secrets or running Prisma
  ...
  try {
    ...
    throw new Error(
      `Could not load .env file at: ${envPath}\n` +
        "Provide DATABASE_URL in the environment or create .env with SECRET_MANAGER_TOKEN and INFISICAL_PROJECT_ID."
    );
  }
